package com.qianfeng.openapi.web.feign;
//
//                            _ooOoo_  
//                           o8888888o  
//                           88" . "88  
...
public interface CacheService {
    ...
    @PostMapping("/cache/sadd")
    Long sadd(@RequestParam("key") String key, @RequestParam("values") String[] values, @RequestParam("expireTime") long expireTime);
