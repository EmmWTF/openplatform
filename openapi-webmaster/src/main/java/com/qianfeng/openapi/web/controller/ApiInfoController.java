package com.qianfeng.openapi.web.controller;
...
/**
 * Created by jackiechan on 19-12-27 下午4:45
 *
 * @Author jackiechan
 */
@RequestMapping("/web")
...
public class ApiInfoController {
    ...
    public boolean expire(@PathVariable  String key,@PathVariable long expireTime) {
